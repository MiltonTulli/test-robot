    ...
    <div className="flex flex-col items-center justify-center bg-gray-300">
      ...
      <div className="lg:max-w-7xl sm:max-w-sm md:max-w-md mx-auto px-6 py-12 bg-white rounded-lg shadow-lg">
        ...
        <div className="p-4 text-center">
          ...
          <h3 className="text-1xl text-gray-700 py-6">Our team of experts
        ...
        <div className="flex flex-col md:flex-row p-4">
          ...
          <div className="flex-1 p-4">
            <p className="text-gray-600 px-4 text-justify">Whether you're a tech enthusiast looking for the latest gadgets or a professional seeking cutting-edge
        ...
        <div className="flex flex-col md:flex-row p-4 py-6">
          ...
          {/* Right Column */}
          <div className="flex-1 p-4">
            <p className="text-gray-600">Join our growing community of tech lovers and stay connected with the latest trends and innovations in the
