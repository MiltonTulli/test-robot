...
export default async function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center  p-24">
      ...
      <div className="mb-12 grid text-center lg:mb-0 lg:grid-cols-12 lg:text-left">
      ...
      <div className="mb-12 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        <p className={`m-0 max-w-[60ch] text-sm opacity-50`}>
          ...
          <ul>
            ...
            <li className="mb-3">
              4. Cada producto deberá mostrarse en su propia productCard y
              deberá tener un link para añadirlo al carro o para abrir su página
              de producto correspondiente (/product/[id])
            </li>
          </ul>
        </p>
      </div>
      <div className="mb-12 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        <p className={`m-0 max-w-[60ch] text-sm opacity-50`}>
          La página individual de cada producto. Deberá mostrar toda la
          información disponible del producto y un link para añadir al carro. El
          carro de momento solo será un context que puede ir agregando o
          removiendo elementos. Crearlo y conectarlo a cada componente que se
          vincule al carro
        </p>
      </div>
    </main>
